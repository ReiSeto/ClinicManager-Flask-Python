...
function setDepartmentData(datas) {
    ...
    for (let i = 0; i < datas.length; i++) {
        ...
        if (department_logo == null)
            department_logo = 'https://isofhcare-backup.s3-ap-southeast-1.amazonaws.com/images/chuyen-khoa-tim-mach-phong-kham-thu-cuc-min-600x339-jpg_90d4708a_0a07_4793_afbb_6d143abfa50f.png'
